  ...
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div class="text-center">
        ...
        <p class="brand-serif mt-2 text-sm text-gray-500 dark:text-dark-400">
...
import { DEFAULT_SITE_NAME, resolveSiteName } from '@/constants/site'
...
onMounted(async () => {
  ...
  try {
    ...
    siteName.value = resolveSiteName(settings.site_name)
