export default {
    accounts: {
      ...
      openai: {
        ...
        firstServeStatus: "首服模式状态（当前网关节点，最近 20 个会话）",
        ...
        firstServeSessionMissing: "账号 {name}：未提供稳定会话标识，本次使用独立组合。要连续复用，请让客户端每轮携带相同的 session_id 请求头或 prompt_cache_key。",
        ...
        firstServeReasons: {
          ...
          connection_failed: "当前会话请求失败且未记录首 token，请检查该账号的代理和上游错误后重试。",
        },
