export default {
    accounts: {
      ...
      openai: {
        ...
        firstServeSessionMissing: "Account {name}: No stable session identity was provided, so this request uses its own combination. To reuse a combination, send the same session_id header or prompt_cache_key on every turn.",
        ...
        firstServeReasons: {
          ...
          connection_failed: "This request failed without a recorded first token. Check this account’s proxy and upstream error, then retry.",
        },
