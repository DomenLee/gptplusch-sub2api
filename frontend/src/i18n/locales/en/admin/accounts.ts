    ...
    accounts: {
      ...
      openai: {
        ...
        firstServeSettings: {
          ...
          hint: "Applies to this account’s WebSocket sessions. Saved settings apply to new conversations; existing sessions keep their settings. If continuation becomes unavailable after a change, start a new conversation or send full history.",
        ...
        firstServeEmpty: "No sessions yet. Save the mode, start a WebSocket request and refresh. Enable WebSocket v2 and mode routing globally.",
        ...
        firstServeReasons: {
          ...
          connection_failed: "Upstream connection failed for this session. Check this account’s proxy and WebSocket settings, then retry.",
        },
        wsModeFirstServe: 'First serve',
        wsModeFirstServeHint: 'For client WebSocket sessions. Safely rotate the proxy and connection on the next turn when first-token latency exceeds the threshold or the combination expires. Bind a proxy group with at least two distinct exits. Response IDs still advance each turn.',
